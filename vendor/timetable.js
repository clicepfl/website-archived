        ...
        Timetable.prototype = {
            ...
            draw: function(e) {
                ...
                function d(e, t) {
                    ...
                    }), c.className = o ? "time-entry " + e.options["class"] : "time-entry", c.style.width = f(e), c.style.left = p(e);
                    
                    var padTime = (time) => String(time).padStart(2, '0')
                    var eventTime = 
                        padTime(e.startDate.getHours()) + ':' +
                        padTime(e.startDate.getMinutes()) + '-' +
                        padTime(e.endDate.getHours()) + ':' +
                        padTime(e.endDate.getMinutes())

                    l.innerHTML = '<span class="time">' + eventTime + '</span><br>' + e.name;
                }
